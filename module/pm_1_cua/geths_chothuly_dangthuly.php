...
if (isset($_COOKIE['auth1cua'])) {
    ...
    $data = array(
        ...
        'dmcoquantochucid' => $auth1cua->coquantochuc,
        'hosodunghan' => $hosodunghan,
        'hososapdenhan' => $hososapdenhan,
        'hosoxulymuon' => $hosoxulymuon,
        'loaidanhgiaid' => null,
        'loaihosoid' => '0,1,2,3,5,4,6,21',
        'malinhvuc' => '',
        'mathutuc' => '',
        'nguoidungid' => $auth1cua->nguoidungId,
        'orderby' => 0,
        'pagenumber' => 1,
        'pagesize' => $pagesize,
        'phongbanid' => $auth1cua->phongbanId,
        'sohoso' => $listHs,
        'trangthaixuly' => $_GET['trangthaixuly'],
        'tungay' => '01/05/2019'
        );
